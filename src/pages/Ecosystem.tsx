...
const Ecosystem: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto pt-24 pb-28 p-6">
      ...
      <h1 className="text-3xl font-normal mb-16"  data-aos="fade-right">
        <span className="block mb-2">How does a smart street</span>
        <span>light ecosystem work?</span>
      </h1>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 relative" data-aos="zoom-in">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-12 md:mb-0" data-aos="zoom-in">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 relative md:px-28 md:ml-3 lg:px-56 lg:ml-4" data-aos="zoom-in">
