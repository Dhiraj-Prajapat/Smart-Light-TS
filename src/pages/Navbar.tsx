...
const Navbar: React.FC = () => {
  ...
  return (
    <div>
      <nav className="flex justify-between items-center p-4 px-4 sm:px-8 md:px-12 lg:px-48 bg-opacity-90 sm:bg-opacity-30 sm:fixed  top-0 w-full bg-black z-40 border-b border-gray-900">
        <a href="#">
